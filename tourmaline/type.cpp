...
llvm::Type *Type::to_llvmty() {
  switch(this->get()) {
    case Type::None:  return llvm::Type::getInt32Ty(context);
    case Type::Int:   return llvm::Type::getInt32Ty(context);
    case Type::Float: return llvm::Type::getDoubleTy(context);
    case Type::String:return llvm::Type::getInt8PtrTy(context);
